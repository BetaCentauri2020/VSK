...
namespace vsk_betacent.Migrations
{
    ...
    [Migration("20200824174034_AddStaffProfileRelatedTables")]
    partial class AddStaffProfileRelatedTables
    {
            ...
            modelBuilder.Entity("vsk_betacent.Models.DataEntities.tbl_staff_profile", b =>
                {
                    ...
                    b.Property<int>("int_fk_sub_area")
                        .HasColumnType("int");

                    b.Property<int>("int_mob")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("vsk_betacent.Models.DataEntities.tbl_staff_profile", b =>
                {
                    ...
                    b.HasOne("vsk_betacent.Models.DataEntities.tbl_sub_area_type", "sub_area_id")
                        .WithMany()
                        .HasForeignKey("int_fk_sub_area")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
